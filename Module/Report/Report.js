...
function openCustomReportPopup(fileName) {
    $('#wms-srv-report-popup').show();
    $('#wms-srv-report-popup-close').off();
    $('#iframeReport').attr('src', 'WMSReport/CustomReport/' + fileName + '/' + fileName + '.html');
...
function getReportListByCategary(categoryId) {
    ...
    /* Static JSON Data */
    var apiPath = 'StaticAPI/GetReportCategoryMenu_' + categoryId +'.json';
    var postData = null;
    /* Static JSON Data */
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            for (var i = 0; i < myGridList.Table.length; i++) {
                ...
                var getFolderName = getReportName.replaceAll(' ', '_');
                gridTable = gridTable + '<div class="col-md-4 nopadding">';
                gridTable = gridTable + '<div class="printablesType" data-id="' + getId + '" data-label="' + getReportName + '" onclick="openCustomReportPopup(\'' + getFolderName + '\');">';
...
function getReportlist() {
    ...
    /* Static JSON Data */
    var apiPath = 'StaticAPI/GetReportCategory.json';
    var postData = null;
    /* Static JSON Data */
