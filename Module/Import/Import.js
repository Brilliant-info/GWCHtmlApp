...
var templateHeader = ['SKUCode:nvarchar', 'Quantity:decimal', 'Price:decimal', 'DeptCode:nvarchar', 'LocationCode:nvarchar', 'ProjectType:nvarchar', 'SiteCode:nvarchar'];
// templateHeader = [];
var userColumnSequence = [];
// DEMO CONTENT...

function demoInitImport() {
    debugger;
    importObject = "";
...
function sendDataToService() {
    ...
    if (extractCell != '') {
        showWMSThemeLoading();
        serverResponseReader(startUploadRowNum, endUploadRowNum);
    } else {
        showProgress();
    }
}
...
function serverResponseReader(startUploadRowNum, endUploadRowNum) {
...
function downloadTemplate(tmpltype) {
    disablemessages = 'Yes';
    location.href = 'StaticAPI/DirectOrderImport.csv';
    disablemessages = 'No';
}
