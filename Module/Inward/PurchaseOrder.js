...
function viewOrderPoDetails(strCurrentOrder, orderstatus, getorderfrom) {
    ...
    // if((obj != 'PurchaseOrder' || obj != 'SalesReturn')  && Number(strCurrentOrder) > 0){
    //     gridTable = gridTable + '<div class="wms-srv-grid-cell" style="text-align:center"></div>'; 
    // }
    if((getorderfrom == 'SR')  && Number(strCurrentOrder) > 0){
        gridTable = gridTable + '<div class="wms-srv-grid-cell" style="text-align:center"></div>'; 
    }
    ...
    if (strCurrentOrder != '0') {
        ...
        callHttpUrl(apiPath, postData, function (data) {
            ...
            if (getCode == "Success") {
                ...
                var getorderfrom = getPoHead[0].orderfrom;
                ...
                // else if(obj != "PurchaseOrder" && Number(strCurrentOrder)>0){
                //     $('#btnPOSave').hide();
                // }
                else {
                    $('#btnPOSave').show();
