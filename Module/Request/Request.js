...
function loadEcommerceRequestList() {
    /* Static API Call */
    apiPath = "StaticAPI/GetEcommerceRequestList.json";
    postData = null;
    /* Static API Call */
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatusCode == 'Success') {
            ...
            if (myGridList != "") {
                ...
                gridTable = gridTable + '<div class="wms-srv-grid-cell" style="width:178px;">Status</div>';
                ...
                for (var i = 0; i < myGridList.length; i++) {
                    ...
                    gridTable = gridTable + '<div class="wms-srv-grid-cell"><div class="wms-srv-status-holder" title="Status" style="width:auto;">' +
                        '<div class="wms-srv-status-display">' +
                        '<div class="wms-srv-status-label" style="width:auto;">New Request</div>' +
                        '<div class="wms-srv-status-progress" style="width:30px;min-width:30px;">' +
...
function loadNormalRequestList() {
    /* Static API Call */
    apiPath = "StaticAPI/GetRequestList.json";
    postData = null;
    /* Static API Call */
