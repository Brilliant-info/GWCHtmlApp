...
function loadEcommerceRequestList() {
    /* Static API Call */
    apiPath = "StaticAPI/GetEcommerceDispatchList.json";
    postData = null;
    /* Static API Call */
            ...
            if (myGridList != "") {
                ...
                for (var i = 0; i < myGridList.length; i++) {
                    ...
                    gridTable = gridTable + '<div class="wms-srv-grid-cell"><div class="wms-srv-status-holder" title="Status">' +
                        ...
                        '<div class="wms-srv-status-label">Out for Delivery</div>' +
                        ...
                        ' <div class="wms-srv-dot wms-srv-green" data-orderid="' + getRequestNo + '" data-status="Expected Receipt" title="Approval" onclick="openApprovalTrans(\'' + getRequestNo + '\');return false;"></div>' +
                        ' <div class="wms-srv-dot wms-srv-red" data-orderid="' + getRequestNo + '" data-status="Expected Receipt" title="Dispatch" onclick="openDispatchPopup(\'' + getRequestNo + '\');return false;"></div>' +
                        '</div>' +
...
function loadNormalRequestList() {
    /* Static API Call */
    apiPath = "StaticAPI/GetDispatchList.json";
    postData = null;
    /* Static API Call */
