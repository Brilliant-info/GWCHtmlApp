...
$(document).ready(function () {
    loadInternalTransferOrderDetail();
});


function loadInternalTransferOrderDetail() {
    debugger;
    restoreTemplate();
    ...
    var apiPath = wmsApiPath + 'Report/InternalTransferDetail';
    var postData =
    {
        "ID": reportDetailId,
        "UserId": reportUserId,
    ...
    loadDetailReport(apiPath, postData, function (data) {
        bindWmsData();
        var getLottableHeader = data.Result.Table3;
