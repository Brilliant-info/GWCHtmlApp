...
function loadputawayOrderDetail() {
    debugger;
    restoreTemplate();
    ...
    var apiPath = wmsApiPath + 'Report/GetPutawaydetail';
    //var apiPath='http://localhost:50068/api/staging/v1/Report/GetPutawaydetail';
    var postData =
    {
        "ID": reportDetailId,
        "UserId": reportUserId,
...
function saveLottableConfiguration() {
    ...
    loadputawayOrderDetail();
    $('#wms-srv-lottableconfigputaway-popup').hide();
}
function showLottableConfiguration() {
    $('#wms-srv-lottableconfigputaway-popup').show();
    $('#wms-srv-lottableconfigputaway-popup-close').off();
    $('#wms-srv-lottableconfigputaway-popup-close').click(function () {
        $('#wms-srv-lottableconfigputaway-popup').hide();
    });
}