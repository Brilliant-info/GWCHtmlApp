...
function loaddispatchOrderDetail() {
    restoreTemplate();
    ...
    var apiPath = wmsApiPath + 'Report/GetDispatchorderdetail';
    var postData =
    {
        "ID": reportDetailId,
        "UserId": reportUserId,
...
function saveLottableConfiguration() {
    ...
    loaddispatchOrderDetail();
    $('#wms-srv-lottableconfigreceiving-popup').hide();
}
function showLottablereceivingConfiguration() {
    $('#wms-srv-lottableconfigreceiving-popup').show();
    $('#wms-srv-lottableconfigreceiving-popup-close').off();
    $('#wms-srv-lottableconfigreceiving-popup-close').click(function () {
        $('#wms-srv-lottableconfigreceiving-popup').hide();
    });
}