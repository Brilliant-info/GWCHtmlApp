...
$(document).ready(function () {
    loadPackingOrderDetail();
});

function loadPackingOrderDetail() {
    debugger;
    restoreTemplate();
    ...
    var apiPath = wmsApiPath + 'Report/PackingOrderdetail';
    var postData =
    {
        "ID": reportDetailId,
        "UserId": reportUserId,
...
function saveLottableConfigurationpacking() {
    //getLottableFilterValues();
    loadPackingOrderDetail();
    $('#wms-srv-lottableconfig-popup').hide();
}
function showLottableConfigurationpacking() {
