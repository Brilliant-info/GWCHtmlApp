    ...
    callHttpUrl(apiPath, postData, function (data) 
    {
        ...
        { 
            ...
            {   
                ...
                gridTable = gridTable + '<div class="wms-srv-grid-row reportRow wmSkuDetailsreportRowshelgaging">';
...
{
    debugger
    var getViewRowCount = $('#'+ gridObjId +' .wmSkuDetailsreportRowshelgaging').length;
    $('#'+ gridObjId +' .gridCellLottable').show();
    for(var l=0; l<10; l++){
         // CHECK FOR VIEW ONLY EMPTY CELL
         var totalCell = $('#'+ gridObjId +' .wmSkuDetailsreportRowshelgaging .gridCellLottable[data-lotindex="'+ l +'"]').length;
         var totalEmptyCell = $('#'+ gridObjId +' .wmSkuDetailsreportRowshelgaging .gridCellLottable[data-lotindex="'+ l +'"]:empty').length;
...
function exportAtClient() 
{
    ...
    $('.previewTable .wmSkuDetailsreportRowshelgaging').each(function () {
