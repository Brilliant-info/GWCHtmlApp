...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/Receiving-Order-Template.html");
}

function openDatePopup() {
    $('#dateSelecterGRNRPT').hide();
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/GRNListReport";
    ...
    var getObject = $("#ddlPageObjectGRNRPT").val();
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'GRNRPT') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Receiving No</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Inward Order Number</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">GRN Date</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">GRN By</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getgrnID = getResult[i].GRNID;
                    var getInwardNo = getResult[i].InwardNo;
                    var getOrderRefNo = getResult[i].OrderRefNo;
                    var getVendorName = getResult[i].VendorName;
                    var getGRNDate = getResult[i].GRNDate;
                    var getCustomerName = getResult[i].CustomerName;
                    var getWarehouseName = getResult[i].WarehouseName;


                    var getPurchaseDate = getResult[i].PurchaseDate;
                    var getExpectedDeliveryDate = getResult[i].ExpectedDeliveryDate;
                    var getOrderRefNo = getResult[i].OrderRefNo;

                    var getGRNBy = getResult[i].GRNBy;
                    var getBatchNo = getResult[i].BatchNo;
                    var getStatus = getResult[i].Status;

                    myGrid = myGrid + '<div id="" class="wms-srv-grid-row reportRow">';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getgrnID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getInwardNo + '</div>';
                    ...
                    // myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPurchaseDate + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getGRNDate + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getGRNBy + '</div>';
                    // myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getBatchNo + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center; display:none;">' + getStatus + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getgrnID + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
