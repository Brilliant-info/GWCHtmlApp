        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                for (var i = 0; i < getResult.length; i++) {
                    ...
                    var getOrderRefNo1 = getOrderRefNo.substring(1, 15);
                    ...
                    var getOutwardorderno1 = getOutwardorderno.substring(1, 15);
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;" title=' + getOutwardorderno1 + '>' + getOutwardorderno1 + '</div>';
                    // myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getClientID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;" title=' + getOrderRefNo1 + '>' + getOrderRefNo1 + '</div>';
