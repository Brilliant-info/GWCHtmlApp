...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    //var apiPath = 'http://localhost:50068/api/staging/v1/ReportStatic/DatewiseEmailReport'
    var apiPath = wmsApiPath + "ReportStatic/DatewiseEmailReport";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Module</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">Order Transaction</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">Email To</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">Email Date</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    ...
                    var getorderTransaction = getResult[i].orderTransaction;
                    var getOrderdate = getResult[i].Orderdate;
                    var getEmailTO = getResult[i].EmailTO;
                    var getEmailDate = getResult[i].EmailDate;
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getorderTransaction + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getOrderdate + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getEmailTO + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getEmailDate + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getStatusName + '</div>';
                    //  myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getDispatchID + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
