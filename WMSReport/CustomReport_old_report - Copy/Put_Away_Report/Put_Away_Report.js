...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/PutAway-Template.html");
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/PutInReport";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center; color: #b3b3b3;font-weight: 500;">Put Away No</div>';
                ...
                //myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">PickUp No</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Vendor/Client/Warehouse</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Put Away Date</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Put Away By</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getPutInID = getResult[i].PutInID;
                    var getPutInDate = getResult[i].PutInDate;
                    var getPurchaseID = getResult[i].PurchaseID;
                    var getOrderNumber = getResult[i].OrderNumber;
                    var getPutInUser = getResult[i].PutInUser;
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPutInID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPurchaseID + '</div>';
                    // myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPickUpNo + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPutInDate + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPutInUser + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center; display:none;">' + getStatus + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getPutInID + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
