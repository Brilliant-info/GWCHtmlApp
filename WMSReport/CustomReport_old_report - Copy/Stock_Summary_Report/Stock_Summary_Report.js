...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/StockSummaryReport";
   // var apiPath ='http://localhost:50068/api/staging/v1/ReportStatic/StockSummaryReport';
            ...
            if (obj == 'objrexta') {
               ...
               myGrid = myGrid + '<div class="wms-srv-grid-header reportHeaderRow" id="header-wrap">';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">SKU Category</div>';
                 myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">SKU Sub Category</div>';
                ...
                for (var i = 0; i < getResult.length; i++) 
                {
                    ...
                    var getName = getResult[i].skuName;
