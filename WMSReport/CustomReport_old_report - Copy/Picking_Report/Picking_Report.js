...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/Picking-Detail-Report.html");
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/PickUpReport";
    // var apiPath = 'http://localhost:50068/api/staging/v1/ReportStatic/PickUpReport';
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell " style="text-align:center; color: #b3b3b3;font-weight: 500;">Picking No</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Picking Date</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">Picking By</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getPickupID = getResult[i].PickupID;
                    var getOrderId = getResult[i].OrderId;
                    // var getOrderId1 = getOrderId.substring(1,5);
                    var getOutwardorderno = getResult[i].Outwardorderno;
                    //var getOutwardorderno11 = getOutwardorderno.substring(1,15);
                    var getPickUpDate = getResult[i].PickUpDate;
                    var getStatusName = getResult[i].StatusName;
                    var getGroupID = getResult[i].GroupID;
                    var getGroupName = getResult[i].GroupName;
                    var getPickByName = getResult[i].PickByName;
                    var getOrderRefNo = getResult[i].OrderRefNo;
                    //var getOrderRefNo11 = getOrderRefNo.substring(1,15);
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPickupID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getGroupID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getGroupName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getOutwardorderno + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPickUpDate + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPickByName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;display:none;">' + getStatusName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getPickupID + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
