...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/Inward-Quality-Detail-Template.html");
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/QCReport";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center; color: #b3b3b3;font-weight: 500;">QC No</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">QC Date</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">QC by</div>';
                ...
                //myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">VendorID</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getpurchaseOrderID = getResult[i].purchaseOrderID;
                    var getQCNo = getResult[i].QCNo;
                    var getOrderRefNo = getResult[i].OrderRefNo;
                    var getPurchaseOrderDate = getResult[i].PurchaseOrderDate;
                    var getObjectName = getResult[i].ObjectName;
                    if (getObjectName == "PurchaseOrder") {
                        getObjectName = "Purchase Order"
                    }
                    var getQCDate = getResult[i].QCDate;
                    var getStatusName = getResult[i].StatusName;
                    var getOrderFrom = getResult[i].OrderFrom;
                    //var getVendorID = getResult[i].VendorID;
                    var getVendorName = getResult[i].VendorName;
                    var getCustomerName = getResult[i].CustomerName;
                    var getQCby = getResult[i].QCby;
                    var getWarehouseName = getResult[i].WarehouseName;


                    myGrid = myGrid + '<div id="" class="wms-srv-grid-row reportRow">';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getQCNo + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getpurchaseOrderID + '</div>';
                    ...
                    //myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getObjectName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getQCDate + '</div>';
                    ...
                    //myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getVendorID + '</div>';
                    //myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getVendorName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getQCby + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center; display:none;">' + getStatusName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getQCNo + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
