...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/InwardDetailList";
    //var apiPath = "http://localhost:50068/api/staging/v1/ReportStatic/InwardDetailList";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Vendor/WH Name</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Vendor/WH Address</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">LR No</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Vehicle No</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell" reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Received Quantity</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">QC Quantity</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Put Away Quantity</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getOrderId = getResult[i].ExpectedRec;
                    ...
                    var getLRNo = getResult[i].LRNo;
                    var getVehicleNo = getResult[i].VehicleNo;
                    var getSKUCode = getResult[i].SKUCode;
                    var getOrderQty = getResult[i].orderqty;
                    var getAllocatedQty = getResult[i].grnqty;
                    var getQcqty = getResult[i].Qcqty;
                    var getputinqty = getResult[i].putinqty;
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getLRNo + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getVehicleNo + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getQcqty + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getputinqty + '</div>';
