    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Order Qty</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell" reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Allocated Qty</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Dispatch Qty</div>';
