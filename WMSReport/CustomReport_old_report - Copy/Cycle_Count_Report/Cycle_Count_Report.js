...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/CycleCountDetail.html");
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/CycleCountReport";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center; color: #b3b3b3;font-weight: 500;">Plan Id </div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Plan Title</div>';
                //  myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Plan ID</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Count Basis</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Cycle Count Date</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">Cycle Count By</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    var getID = getResult[i].Planid;
                    var getPlanTitle = getResult[i].PlanTitle;
                    //  var getPlanID = getResult[i].PlanID;
                    var getCreationDate = getResult[i].Cycle_Count_Date;
                    var getStatusName = getResult[i].Status;
                    var getWarehouseName = getResult[i].WarehouseName;
                    var getCountBasis = getResult[i].CountBasis;
                    var getUserName = getResult[i].CyclecountBy;
                    //  var getSkuCode = getResult[i].SkuCode;
                    var getPlanID = getResult[i].CyPlanID;



                    myGrid = myGrid + '<div id="" class="wms-srv-grid-row reportRow">';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPlanID + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getPlanTitle + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getCountBasis + '</div>';
