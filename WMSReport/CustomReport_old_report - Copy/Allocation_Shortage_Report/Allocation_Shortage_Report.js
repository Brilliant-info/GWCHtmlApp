...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/Allocation-shrotage-Template.html");
}
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    //var apiPath = 'http://localhost:50068/api/staging/v1/ReportStatic/AllocatonShrotage';
    var apiPath = wmsApiPath + "ReportStatic/AllocatonShrotage";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Client/WH Name</div>';
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">Shortage Quantity</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    ...
                    var getShrotageqty = getResult[i].shoratageQty;
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getShrotageqty + '</div>';
