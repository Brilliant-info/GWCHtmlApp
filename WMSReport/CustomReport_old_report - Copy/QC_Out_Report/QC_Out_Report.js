...
function openDetailReport(dataVal) {
    ...
    window.open("../../DetailReport/Outward-Quality-Check.html");
}
...
var currentfinacial = "2023/04/01";
...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    var apiPath = wmsApiPath + "ReportStatic/QCOutReport";

    // var apiPath = 'http://localhost:50068/api/staging/v1/ReportStatic/QCOutReport';
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                for (var i = 0; i < getResult.length; i++) {
                    ...
                    var getOutwardId = getResult[i].OutwardId;
                    var getOrderrefnumber = getResult[i].Orderrefnumber;
                    var getClientadd = getResult[i].Clientadd;
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getQCID + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getOutwardId + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getOrderrefnumber + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getClientCode + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getClientadd + '</div>';
                    ...
                    myGrid = myGrid + '<div class="wms-srv-grid-cell reportRowCell" style="text-align:center;">' + getStatusName + '</div>';
                    myGrid = myGrid + '<div class="wms-srv-grid-cell"  onclick="openDetailReport(' + getQCID + ');"style="text-align:center;"><i class="fas fa-solid fa-eye"></i></div>';
                    myGrid = myGrid + '</div>';
