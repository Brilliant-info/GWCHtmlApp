...
function getPurchaseOrderList(getSelectedDateCatg, fromDate, toDate) {
    ...
    var getSearchToDate = "";
    //var apiPath = 'http://localhost:50068/api/staging/v1/ReportStatic/getCustomerSummary';
    var apiPath = wmsApiPath + "ReportStatic/getCustomerSummary";
    ...
    callHttpUrl(apiPath, postData, function (data) {
        ...
        if (getStatus == 200) {
            ...
            if (obj == 'objrexta') {
                ...
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style="text-align:center;color: #b3b3b3;font-weight: 500;">SKU Category</div>';
                myGrid = myGrid + '<div class="wms-srv-grid-cell reportHeaderCell" style=" text-align:center;color: #b3b3b3;font-weight: 500;">SKU SubCategory</div>';
                ...
                for (var i = 0; i < getResult.length; i++) {
                    ...
                    var getWarehouseCode = getResult[i].WarehouseName;
                    var getProductCode = getResult[i].ProductCode;
                    ...
                    var getAvailableBalance = getResult[i].avaqty;
